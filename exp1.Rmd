...
subject_data <- read_csv("data/parsed_trials.csv") %>%
  ...
  mutate(scene = as.numeric(scene),
         ...
         target_gt = case_when(target_gt=="trg" ~ TRUE,
                               target_gt=="dis" ~ FALSE),
         probe_gt = case_when(probe_gt =="probe" ~ TRUE,
                              probe_gt=="noprobe" ~ FALSE),)

# quick performance check
tracking <- subject_data$Target == subject_data$target_gt
probes <- subject_data$Probe == subject_data$probe_gt
