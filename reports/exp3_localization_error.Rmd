...
# model_name = "exp3_localization_error_adaptive_computation_td"
model_name = "exp3_localization_error_ac_td"


# covariates pre-processed by `scripts/exp1_attention_process_chains.R`
exp_data <- read_csv(paste("../data/exp3/", model_name, "_att.csv", sep="")) %>%
  filter(frame > 12)

dnd_data <- read_csv(paste("../data/exp3/", model_name, "_dnd.csv", sep="")) %>%
  select(-contains("pred"))

model_perf <- read_csv(paste("../data/exp3/", model_name, "_perf.csv", sep=""))
