...
# model_att <- read_csv("../data/exp1/exp1_difficulty_adaptive_computation_td_att.csv")
# model_perf <- read_csv("../data/exp1/exp1_difficulty_adaptive_computation_td_perf.csv")
model_att <- read_csv("../data/exp1/exp1_difficulty_ac_td_att.csv")
model_perf <- read_csv("../data/exp1/exp1_difficulty_ac_td_perf.csv")
...
ggsave("fig3_b.svg", plot = fig3_b, height=4,width=7)
